    ...
    <body style="background-color: gray">
        <div class="myDiv1">
            ...
            <ul>
              ...
              <form action="./insertinto" method="post">
              <div class="myDiv4">
              <h1 style="color:white">New Account</h1>
              <label for="username"><b style="color:white">UserName  </b>
              <input type="text" placeholder="Enter UserName" name="usn" id="usn" required><br><br></label>
              <label for="account"><b style="color:white">Account No.  </b>
              <input type="number" placeholder="Enter Account Number" name="account" id="account" required><br><br></label>
               <label for="psw"><b style="color:white">Password  </b>
               <input type="password" placeholder="Enter Password" name="psw" id="psw" required onkeyup="check();"/><br><br></label>
               <label for="psw-repeat"><b style="color:white">Repeat Password </b>
               <input type="password" placeholder="Repeat Password" name="psw-repeat" id="psw-repeat" required onkeyup="check();"/>

...
<html>
    <head>
        <title>Balance-Login(Incorrect)</title>
        <style>
            .myDiv1{ 
                display: grid;
                width:1400;
  ...
  opacity: 1;
    ...
    <body style="background-color: gray">
        <div class="myDiv1">
            ...
            <ul>
                <li><h3><a href="front_page.jsp">Home</a></h3></li>
                <li><h3><a href="NewAccont.jsp">New Account</a></h3></li>
              ...
              <form action="./loginto1" method="post">
              <div class="myDiv4">
              <h1 style="color:white">Login to Check your Balance</h1>
              ...
              <input type="text" placeholder="Enter UserName" name="usn" id="usn" required><br><br></label>
               ...
               <h3 style="color:white">Wrong Password or Username</h3>
               </div>
               </div>
               </form>
            <div class="myDiv6">

    ...
    <body style="background-color: gray">
        <div class="myDiv1">
            ...
            <ul>
                ...
                <li><h3><a href="Deposit.java">Deposit</a></h3></li>
                <li><h3><a href="Transfer.java">Transfer</a></h3></li>
                <li><h3><a href="CloseAccount.java">Close Account</a></h3></li>
                <li><h3><a href="redirect.jsp">Logout</a></h3></li>
            </ul>
              <div class="myDiv4">
              <form action="./transfdata" method="post">
              <h2 style="color:white">Transfer</h2>
              <h4 style="color:white">UserName:  <%=s %></h4>
              <label for="acc_no1"><b style="color:white">Account No 1:</b>
              <input type="number" placeholder="Enter Account Number 1" name="acc_no1" id="acc_no1" required><br></label>
               <label for="acc_no2"><b style="color:white">Account No 2:</b>
               <input type="number" placeholder="Enter Account Number 2" name="acc_no2" id="acc_no2" required><br></label>
               <label for="balance"><b style="color:white">Enter Amount:</b>
               <input type="number" placeholder="Enter amount" name="bal" id="bal" required><br></label>
               <hr>
